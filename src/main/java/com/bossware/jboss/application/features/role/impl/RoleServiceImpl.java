...
public class RoleServiceImpl implements RoleService {
    ...
    @Override
    public ResponseEntity<List<RoleResponseDto>> findRolesByUserName(String userName) {
    ...
    @Override
    public ResponseEntity<List<RoleResponseDto>> findRolesByEmail(String userEmail) {
        List<Role> roleList = roleRepository.findROlesByUserEmail(userEmail);
        List<RoleResponseDto> res = mapper.entityToRespList(roleList);
        return new ResponseEntity<>(res, HttpStatus.OK);    }
}
